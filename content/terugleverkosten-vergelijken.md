---
title: "Terugleverkosten vergelijken per energieleverancier (2026)"
description: "Terugleverkosten per leverancier naast elkaar: wie rekent een staffel per dag, wie een bedrag per kWh en wie helemaal niets. Alleen bedragen die de leverancier zelf publiceert, met peildatum."
layout: "single"
...
- q: 'Wat zijn terugleverkosten precies?'
  a: 'Terugleverkosten zijn kosten die je leverancier rekent voor de stroom die je zonnepanelen aan het net teruggeven. Ze staan los van de terugleververgoeding die je voor diezelfde stroom ontvangt: die twee worden apart verrekend. Sommige leveranciers rekenen een vast bedrag per teruggeleverde kWh, andere een vast bedrag per dag op basis van een staffel waar je jaarlijkse teruglevering je in plaatst. Bij vrijwel alle volledig dynamische contracten worden geen terugleverkosten gerekend, omdat de uurprijs zelf al negatief kan worden op momenten met veel zon.'
- q: 'Waarom staat bij zoveel leveranciers "zie site" in jullie tabel?'
  a: 'Omdat een groot deel van de leveranciers het bedrag niet vrij toegankelijk publiceert. Eneco, ENGIE en Oxxio verwijzen voor de hoogte van de terugleverkosten expliciet naar je leveringsovereenkomst, de app of de mijn-omgeving; Greenchoice noemt alleen het model, niet het tarief. Wij nemen uitsluitend bedragen op die we op de site van de leverancier zelf kunnen teruglezen. Cijfers overtypen van een vergelijkingssite zou de indruk van leverancierswaarheid geven die ze niet hebben.'
- q: 'Betaal ik terugleverkosten bij een dynamisch contract?'
  a: 'Bij de dynamische contracten die wij op de leverancierssites konden controleren: nee. ANWB Energie, Zonneplan en Budget Thuis stellen letterlijk dat ze geen terugleverkosten rekenen, Vattenfall vermeldt dat je bij FlexPrijs geen vaste terugleverkosten betaalt, energiedirect noemt bij dynamisch geen extra kosten voor teruglevering en Eneco rekent bij dynamisch met het uurtarief. Wat er wel gebeurt: de prijs per uur zelf kan laag of negatief zijn op zonnige middagen, en bij Tibber en Eneco gaat er een verkoopvergoeding van je opbrengst af. Gratis is dus niet hetzelfde als kosteloos.'
- q: 'Verdwijnen terugleverkosten als de saldering op 1 januari 2027 stopt?'
  a: 'Nee, het model verandert. Vattenfall vermeldt zelf dat het vanaf 1 januari 2027 overgaat op variabele terugleverkosten — een bedrag per kWh in plaats van een vast bedrag per staffel — en Budget Thuis schrijft hetzelfde. Essent en energiedirect melden dat terugleververgoeding en terugleverkosten vanaf die datum anders worden berekend. Reken er dus niet op dat je huidige staffelbedrag na 2026 nog geldt.'
...
## Wat terugleverkosten zijn, en waarom ze bestaan
...
Twee valkuilen in de kleine letters:

1. **Je betaalt over álle teruggeleverde stroom, niet over het saldo.** Essent en energiedirect schrijven het bijna woordelijk hetzelfde: het gaat om "álle stroom die je hebt opgewekt, maar niet direct verbruikt". Ook het deel dat je nog mag salderen, valt eronder.
2. **Een staffelbedrag per dag voelt klein en telt hard op.** € 1,38 per dag klinkt als niets, maar dat is ruim € 500 per jaar.

## Vergelijkingstabel terugleverkosten per leverancier

<p style="background:#f1f5f9;border-left:4px solid #0e7490;padding:.8rem 1rem;border-radius:0 8px 8px 0;font-size:.92rem;">
<strong>Hoe deze tabel is gerangschikt:</strong> alfabetisch op leveranciersnaam. Dat is de enige rangschikkingsparameter — geen commissie, geen redactionele voorkeur, geen "beste keuze" bovenaan. Alle feiten komen van de site van de leverancier zelf, gecontroleerd op <strong>20 augustus 2026</strong>. Bedragen die een leverancier niet vrij toegankelijk publiceert, staan als <em>zie site</em>: die zie je pas in je contract, de app of de mijn-omgeving. Wij nemen geen tarieven over van vergelijkingssites.
</p>

<div style="overflow-x:auto;margin:1.5rem 0;">
<table style="border-collapse:collapse;width:100%;min-width:960px;font-size:.9rem;">
  <thead>
    <tr style="background:#0e7490;color:#fff;text-align:left;">
      <th style="padding:.7rem;">Leverancier</th>
      <th style="padding:.7rem;">Contracttype</th>
      <th style="padding:.7rem;">Terugleverkosten / model</th>
      <th style="padding:.7rem;">Peildatum</th>
      <th style="padding:.7rem;">Bron</th>
    </tr>
  </thead>
  <tbody>
    ...
    <tr style="border-bottom:1px solid #e2e8f0;background:#fafbfc;">
      ...
      <td style="padding:.7rem;vertical-align:top;">20 aug 2026</td>
      <td style="padding:.7rem;vertical-align:top;"><a href="https://www.zonneplan.nl/energie/zonnepanelen/terugleverkosten" target="_blank" rel="noopener nofollow">zonneplan.nl</a></td>
    </tr>
  </tbody>
</table>
</div>

<p style="font-size:.86rem;color:#555;">Peildatum per cel; tarieven wijzigen regelmatig — de leverancierssite is altijd leidend. Aan deze informatie kunnen geen rechten worden ontleend.</p>

### Wat je uit deze tabel wél en niet kunt concluderen
...
Er zijn drie routes, en ze zijn te combineren.
...
<p style="margin:1.4rem 0;"><a class="cta cta-affiliate" href="https://go.duurzaamthuislab.nl/energiedirect?ref=/terugleverkosten-vergelijken/" target="_blank" rel="noopener nofollow sponsored">Bekijk energiedirect →</a></p>

**2. Verbruik meer van je eigen stroom.** Elke kWh die je zelf gebruikt op het moment van opwekken, komt niet in een staffel en niet in een tarief per kWh terecht. Dat is de enige route die bij élk contracttype werkt. Een thuisbatterij is de grofste knop: die schuift een deel van je middagproductie naar de avond. Of dat uit kan hangt af van je teruglevervolume en je tarieven, en dat kun je narekenen met onze [terugverdientijd-berekening voor thuisbatterijen](/terugverdientijd-thuisbatterij/). Gratis varianten: apparaten met een hoog verbruik in het zonnige deel van de dag laten lopen, en je auto thuis laden. Hoe die uren eruitzien lees je op [beste tijd om de wasmachine te laten draaien](/beste-tijd-wasmachine/).

De volledige achtergrond bij deze post — hoe hij is ontstaan en hoe hij zich verhoudt tot de terugleververgoeding — staat in [terugleverkosten zonnepanelen 2026](/posts/terugleverkosten-zonnepanelen-2026/).

**3. Reken op een ander speelveld na 1 januari 2027.** De salderingsregeling stopt dan, en meerdere leveranciers kondigen op hun eigen site al aan dat de terugleverkosten van staffel naar een bedrag per kWh gaan (Vattenfall en Budget Thuis noemen dat letterlijk). Dat verandert de rangorde: wie nu veel teruglevert en in een hoge staffel zit, kan er relatief op vooruitgaan, terwijl kleine terugleveraars die nu onder een vrijstellingsdrempel vallen — bij Vattenfall 500 kWh — juist gaan betalen. Wat er precies verandert en welke keuzes je nú al kunt maken, staat in onze [volledige gids over het einde van de saldering in 2027](/posts/saldering-stopt-2027-volledige-gids/).
