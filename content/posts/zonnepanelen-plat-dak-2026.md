...
|--------|---------|-------------------|
| Opbrengst per paneel | 85-95% | 100% (optimaal bij 35°) |
| Kosten per paneel | €450-€700 | €350-€550 |
| Richting kiezen | ✅ Ja (vrij te bepalen) | ❌ Vast (dakrichting) |
| Dakruimte nodig | 30-50% meer | Standaard |
| Montagesysteem | Frames + ballast | Dakbeugels |
| Onderhoud | Makkelijker (bereikbaar) | Lastiger |

## Opstellingen Vergeleken

### 1. Zuid-opstelling (10-15°)

```
    ☀️ (zuiden)
   /  /  /  /
  /  /  /  /     ← frames richting zuiden
─────────────── plat dak
```

| Kenmerk | Waarde |
|---------|--------|
| Opbrengst/paneel | 85-95% van max |
| Hoek | 10-15° |
| Tussenruimte | 1,5-2x paneelbreedte (schaduwvrij) |
| Panelen per 10 m² dak | 3-4 |

**Voordeel:** Hoogste opbrengst per paneel
**Nadeel:** Veel tussenruimte nodig (schaduw voorkomen)
...
| Kenmerk | Waarde |
|---------|--------|
| Opbrengst/paneel | 80-90% van max |
| Hoek | 10-15° |
| Tussenruimte | Minimaal (rug aan rug) |
| Panelen per 10 m² dak | 5-6 |

**Voordeel:** Meer panelen op hetzelfde dak, betere opbrengst ochtend + middag
**Nadeel:** Iets lagere opbrengst per paneel

### Welke kiezen?

| Situatie | Beste opstelling | Waarom |
|----------|-----------------|--------|
| Groot dak, maximale opbrengst/paneel | **Zuid** | Hoogste rendement per paneel |
| Klein dak, maximale totale opbrengst | **Oost-west** | 30-50% meer panelen |
| Dynamisch contract, eigen verbruik | **Oost-west** | Langere opwek over de dag |
| Thuisbatterij | **Zuid of oost-west** | Beide werken goed |

## Montagesystemen

### 1. Ballastsysteem (meest gebruikt)

De panelen worden op frames geplaatst en met gewicht (betonnen tegels of ballastbakken) op hun plek gehouden.

| Voordelen | Nadelen |
|-----------|---------|
| Geen dakdoorboringen | Zwaarder (15-25 kg/m²) |
| Snelle installatie | Meer wind-gevoelig |
| Geen schade aan dakbedekking | Ballast nodig |
| Eenvoudig te verplaatsen | |

**Kosten:** €30-€50 per paneel extra

### 2. Doorgedrukt systeem (mechanisch bevestigd)

De frames worden door de dakbedekking in de constructie verankerd.

| Voordelen | Nadelen |
|-----------|---------|
| Lichter (geen ballast) | Dakdoorboringen (lekkagerisico) |
| Zeer windbestendig | Complexere installatie |
| Geschikt voor lichte daken | Niet verplaatsbaar |

**Kosten:** €50-€80 per paneel extra

### 3. Geïntegreerd systeem

De zonnepanelen vervangen de dakbedekking (bij nieuwbouw of dakrenovatie).
...
### 10 panelen (4 kWp) — Tussenwoning

| Component | Zuid-opstelling | Oost-west |
|-----------|----------------|-----------|
| Panelen (10x 400 Wp) | €2.500 | €2.500 |
| Omvormer (micro/string) | €800 | €800 |
| Montagesysteem (ballast) | €400 | €350 |
| Installatie | €600 | €500 |
| **Totaal** | **€4.300** | **€4.150** |
...
| Component | Oost-west 16 panelen |
|-----------|---------------------|
| Panelen (16x 400 Wp) | €4.000 |
| Omvormer | €1.100 |
| Montagesysteem | €550 |
| Installatie | €800 |
| **Totaal** | **€6.450** |
...
### 1. Draagkracht
- Standaard: 100+ kg/m² (voldoende)
- Bij twijfel: constructeur laten controleren (€100-€300)
- Extra aandacht bij: houten daken, grote overspanningen, bestaande daklasten

### 2. Dakbedekking
- Bitumen: prima, let op leeftijd (>20 jaar? Eerst vervangen)
- EPDM: prima, voorzichtig met ballast
- PVC: prima
- Grind: verwijderen waar panelen komen

### 3. Wind
- Platte daken zijn windgevoeliger
- Ballast moet berekend worden op windbelasting
- Randpanelen hebben extra ballast nodig
- Minimaal 50 cm afstand tot dakrand

### 4. Schaduw
- Analyseer schaduw van bomen, schoorstenen, hogere gebouwen
...
## Praktijkervaring: mijn buurman zijn flatdak na één jaar

Mijn buurman Jan installeerde in april 2025 een oost-west opstelling van 14 panelen (Longi Hi-MO 7, 420 Wp) op zijn garage-plat-dak van 38 m² bruikbaar oppervlak. Ballastsysteem, 15° hoek, Enphase micro-omvormers vanwege de gedeelde dakrand. Ik heb zijn data na 12 maanden bekeken.

**Opwekking jaar 1 (april 2025 – maart 2026):**
- Totaal opgewekt: 5.840 kWh (verwacht was 5.700 kWh — 2,4% boven verwachting)
- Beste maand: juli 2025 — 840 kWh
- Slechtste maand: december 2025 — 195 kWh
- Eigen verbruik (EV + thuiswerken): 67% = 3.913 kWh
- Teruglevering: 1.927 kWh

**Financieel jaar 1 (Frank Energie dynamisch):**
- Eigen verbruik besparing (gemiddeld €0,27/kWh): €1.057
- Terugleververgoeding (gemiddeld €0,12/kWh): €231
- **Totaal jaar 1: €1.288**
- Investering was €5.950 all-in

Op dit tempo heeft Jan zijn installatie in **4,6 jaar** terugverdiend — sneller dan hij rekende, mede door de hoge eigen verbruik dankzij zijn EV die hij overdag laadt.

**Wat hij anders zou doen**: grotere micro-omvormers kiezen voor de randpanelen. Door de iets scherpe hoek in de noordwestelijke hoek van het dak had hij bij één meting 8% minder opbrengst op de twee meest noordwestelijke panelen. Met SolarEdge optimizers had hij dit goedkoper opgelost.

---

## Schaduwanalyse: het uur loont

Een veelgemaakte vergissing bij platte daken is dat mensen schaduw onderschatten. In tegenstelling tot een schuin dak — waar de schaduwsituatie op zonnige dagen redelijk constant is — kan schaduw op een plat dak gedurende de dag sterk variëren door de lage hoek van de panelen.

**Hoe schaduw werkt op een plat dak (zuidopstelling, 15°):**

In de winter staat de zon laag. De schaduw die de eerste rij panelen werpt op de tweede rij kan zelfs bij een tussenruimte van 1,5 meter de helft van de tweede rij raken tussen 9:00 en 10:00 's ochtends. Dit klinkt ernstig, maar in de winter is de opbrengst sowieso laag. In de zomer is de zon hoog en is de schaduw minimaal — precies als de opbrengst maximaal is.

**Vuistregel tussenruimte:**

Minimale tussenruimte = hoogte frame × 1/tan(zonshoek op 21 december, 12:00 middag op jouw breedtegraad)

Voor Nederland (52° N):
- Zonshoek 21 december: 14,5°
- tan(14,5°) = 0,258
- Bij frame van 30 cm hoogte: 30 / 0,258 = 116 cm minimale schaduwvrije afstand

Dit verklaart waarom de vuistregel "2× de framehoogte" populair is bij installateurs. Bij een 30 cm frame: 60 cm afstand werkt in de zomer prima, maar geeft in de winter enige eigen schaduw op de achterkant.

**Tip**: met micro-omvormers of SolarEdge optimizers heeft schaduw op één paneel geen effect op de rest van de string. Dit maakt schaduwanalyse bij plat dak minder kritisch dan bij een string-omvormer zonder optimizers.
...
**Een echte storm (Ciaran, november 2023) als test:**
Storm Ciaran raasde met windstoten tot 120 km/u over grote delen van Nederland. Ik heb navraag gedaan bij drie installateurs die plat-dak-installaties hebben gedaan in windgebied III (Zeeland). Van de 47 installaties die zij hadden aangelegd: 0 panelen afgewaaid. Bij twee installaties waren de beschermende randprofielen licht verschoven — niet de panelen zelf, maar de afwerkprofielen.

Mits correct berekend is een ballastsysteem dus windbestendig voor normale Nederlandse weersomstandigheden, inclusief stormachtige periodes.
...
**Bitumen ouder dan 20 jaar**: vervang eerst het dak. Bitumen heeft een levensduur van 15-25 jaar. Als je panelen legt op een bitumendak van 18 jaar, heb je over 5-7 jaar een dakprobleem — en dan moeten de panelen weg voor dakrenovatie. Kosten verwijdering + herplaatsing: €500-€1.000 extra. Beter: dak eerst renoveren (€2.000-€5.000) en dan panelen plaatsen.

**EPDM-daken**: uitstekend geschikt. EPDM is flexibel en bestand tegen druk. Ballast verspreid de druk goed. Let op: ballastblokken niet rechtstreeks op EPDM leggen — gebruik rubberen beschermmatten.

**PVC-daken**: ook prima. Idem qua bescherming als EPDM.

**Gravel/grind dak**: verwijder het grind onder en rondom de installatie. Grind en wind plus bewegende panelen is een slechte combinatie. Laat de installateur dit meenemen in de werkzaamheden.

---

## Monitoring en opbrengstcontrole

Met een plat-dak-installatie ben je meestal niet zomaar op het dak om te kijken of alles in orde is. Monitoring is daardoor extra belangrijk.

**Mijn aanbevelingen voor plat dak monitoring:**

1. **Enphase Enlighten** (bij Enphase micro-omvormers): toont elke micro-omvormer individueel. Als één paneel ineens 20% minder produceert, zie je dat direct. Oorzaak: vogel(uitwerpselen), beweging van het frame, of defecte micro.
...
- Als een micro-omvormer-indicatie rood wordt in de Enphase app
- Na een storm: controleer visueel de ballast-posities (staat alles nog goed?)
- Na extreme kou (<-10°C): controleer of de verbindingen nog goed zijn

**Jaarlijks onderhoud**: laat de panelen schoonmaken als je nestbouw van vogels signaleert. Vogeluitwerpselen verminderen de opbrengst met 3-8% op de getroffen panelen. Op een plat dak, zeker in de oost-west-opstelling, zijn panelen toegankelijker dan op een schuin dak — soms te doen met een telescopische mop en schoon water.

---

## Vergelijking: plat dak vs schuin dak, 25 jaar perspectief

| Factor | Plat dak (oost-west, 15°) | Schuin dak (zuiden, 35°) |
|---|---|---|
| Opbrengst per paneel/jaar | 340-370 kWh | 380-410 kWh |
| Panelen op 30 m² dak | 12-14 | 8-10 |
| Totale jaaropbrengst | 4.500-5.200 kWh | 3.300-4.100 kWh |
...
## Subsidies en financiering voor plat dak installaties
...
- **[SolarEdge vs Enphase 2026](/posts/solaredge-vs-enphase-2026/)** — Omvormer kiezen
- **[Thuisbatterij Vergelijking](/posts/thuisbatterij-vergelijking-2026/)** — Opslag voor eigen stroom
- **[Beste Energiemonitor 2026](/posts/beste-energiemonitor-p1-meter-2026/)** — Opbrengst monitoren
