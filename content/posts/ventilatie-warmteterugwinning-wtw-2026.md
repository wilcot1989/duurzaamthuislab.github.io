...
```
Buiten (koud, fris)  →  [WTW unit]  →  Binnen (warm, fris)
                          ↕
Binnen (warm, vuil)  →  [warmtewisselaar]  →  Buiten (koud, vuil)
```

1. **Afvoer:** Warme, vochtige lucht wordt uit keuken, badkamer en toilet gezogen
2. **Warmtewisselaar:** De warmte uit de afvoerlucht wordt overgedragen aan de verse buitenlucht
3. **Toevoer:** Voorverwarmde, gefilterde buitenlucht wordt in woon- en slaapkamers geblazen
4. **Rendement:** 80-95% van de warmte wordt teruggewonnen

### Verschil met andere ventilatietypen

| Type | Werking | Warmteverlies | Geluid | Kosten |
|------|---------|-------------|--------|--------|
| **Natuurlijk** (roosters + ramen) | Geen mechanisch | 100% (alle warmte weg) | Stil | €0 |
| **Mechanisch C** (alleen afvoer) | Ventilator zuigt af | 100% (alle warmte weg) | Laag | €200-€500 |
| **Mechanisch D / WTW** (balans) | Afvoer + toevoer + warmtewisselaar | 5-20% (80-95% teruggewonnen) | 25-35 dB | €3.000-€6.000 |

## Beste WTW-units 2026

| Unit | Prijs | Rendement | Geluid | Debiet | Beste voor |
|------|-------|----------|--------|--------|-----------|
| **Brink Flair 325** | €1.800 | 95% | 26 dB | 325 m³/h | Tussenwoning |
| **Zehnder ComfoAir Q** | €2.500 | 95% | 28 dB | 350-600 m³/h | Grotere woningen |
| **Itho Daalderop HRU ECO** | €1.500 | 90% | 30 dB | 300 m³/h | Budget |
| **Vaillant recoVAIR** | €2.200 | 93% | 28 dB | 400 m³/h | Vaillant warmtepomp |
| **Duco DucoBox Energy** | €2.000 | 90% | 29 dB | 400 m³/h | Retrofit |

### 1. Brink Flair 325 — Beste voor tussenwoning

De Brink Flair 325 is de populairste WTW-unit in Nederland: compact, stil en met het hoogste rendement.

**Waarom de beste:**
- 95% warmteterugwinning — marktleidend rendement
- 26 dB — stilste unit in zijn klasse
- Compacte afmetingen — past op kleine zolders
- Nederlandse makelij — goede service en onderdelenvoorziening
- Home Assistant koppelbaar via iFan

### 2. Zehnder ComfoAir Q — Beste voor grotere woningen

De Zehnder ComfoAir Q biedt het grootste debiet en de meest geavanceerde bediening.

**Waarom kiezen:**
- Geschikt voor woningen tot 200+ m²
- ComfoConnect app — volledige controle via smartphone
- Enthalpiewisselaar — wint ook vocht terug (beter binnenklimaat)
- Modulaire kanaalopzet — flexibel in installatie

### 3. Itho Daalderop HRU ECO — Beste budget

De Itho HRU ECO biedt solide prestaties voor de laagste prijs.

**Waarom kiezen:**
- Laagste prijs voor een betrouwbare WTW-unit
...
| Component | Kosten bestaande bouw | Kosten nieuwbouw |
|-----------|---------------------|-----------------|
| WTW-unit | €1.500-€3.000 | €1.500-€3.000 |
| Kanaalwerk | €1.000-€2.500 | €500-€1.000 |
| Roosters en ventielen | €200-€400 | €200-€400 |
| Installatie arbeid | €500-€1.500 | €300-€800 |
| **Totaal** | **€3.200-€7.400** | **€2.500-€5.200** |

### Jaarlijkse besparing

| Woningtype | Zonder WTW (gaskosten ventilatie) | Met WTW | Besparing/jaar |
|-----------|--------------------------------|---------|---------------|
| Appartement (80 m²) | €350 | €50-€100 | €250-€300 |
| Tussenwoning (120 m²) | €500 | €75-€125 | €375-€425 |
| Hoekwoning (130 m²) | €600 | €90-€150 | €450-€510 |
| Vrijstaand (180 m²) | €800 | €120-€200 | €600-€680 |

### Terugverdientijd

| Scenario | Investering | Besparing/jaar | Terugverdientijd |
|----------|-----------|---------------|-----------------|
| Bestaande tussenwoning | €4.500 | €400 | 11 jaar |
| Nieuwbouw tussenwoning | €3.000 | €400 | 7,5 jaar |
| Bestaande vrijstaand | €6.000 | €640 | 9,5 jaar |
| Met ISDE subsidie (-€1.000) | €3.500 | €400 | 8,5 jaar |

## Voordelen Naast Energiebesparing

### 1. Luchtkwaliteit
- Filters houden fijnstof, pollen en vervuiling buiten
- CO₂-niveau blijft laag (beter slapen, concentreren)
- Geen geluidsoverlast van buitenaf (ramen dicht)

### 2. Vochtbeheersing
- Voorkomt schimmel in badkamer en keuken
- Stabiel vochtpercentage (40-60% relatief)
- Geen condensatie op ramen

### 3. Comfort
- Geen tocht van open roosters of ramen
- Gelijkmatige temperatuur in hele woning
- Minder stof in huis (filters)

### 4. Energielabel
- WTW verbetert je energielabel met 1-2 stappen
- Verplicht bij energielabel A of beter
- Verhoogt de woningwaarde

## WTW + Warmtepomp: De Ideale Combinatie

Een WTW-systeem en warmtepomp versterken elkaar:

| Aspect | Alleen warmtepomp | Warmtepomp + WTW |
|--------|------------------|------------------|
| Ventilatiewarmteverlies | Hoog (warmtepomp compenseert) | Minimaal (WTW vangt op) |
| COP warmtepomp | 3,5-4,0 | 4,0-4,5 (minder vermogen nodig) |
| Verwarmingskosten | €800-€1.200/jaar | €500-€800/jaar |
| Comfort | Goed | Uitstekend |
...
- Filters vervangen (€20-€40 per set)
- Roosters en ventielen stofzuigen
- Condensafvoer controleren

### Professioneel (elke 2-3 jaar)
- Warmtewisselaar reinigen
- Kanalen inspecteren
- Debieten controleren en bijstellen
- Kosten: €100-€150 per beurt

### Jaarlijkse onderhoudskosten
| Item | Kosten/jaar |
|------|------------|
| Filters (2-3 sets) | €40-€120 |
| Professioneel onderhoud (per 2 jr) | €50-€75 |
| Elektriciteitsverbruik unit | €30-€60 |
| **Totaal** | **€120-€255** |

## Subsidie

- **ISDE:** WTW-systemen komen in aanmerking voor ISDE-subsidie als onderdeel van een verduurzamingspakket
- **Gemeente:** Sommige gemeenten bieden aanvullende subsidie voor ventilatie
...
- **[Vloerverwarming + Warmtepomp](/posts/vloerverwarming-warmtepomp-combinatie-2026/)** — Ideale combinatie
- **[Isolatie Subsidie 2026](/posts/isolatie-subsidie-nederland-2026/)** — Alle subsidies
- **[Smart Home Energiebeheer](/posts/smart-home-energiebeheer-2026/)** — Automatiseer je ventilatie
