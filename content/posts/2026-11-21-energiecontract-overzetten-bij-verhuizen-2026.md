---
title: "Energiecontract overzetten bij verhuizen: stappenplan 2026"
date: 2026-11-21
draft: false
description: "Energiecontract regelen bij verhuizing: Tibber, Frank Energie of Vattenfall overzetten, slimme meter uitlezen, eindafrekening en oplevermoment stap voor stap."
keywords:
  - energiecontract overzetten verhuizen
  - energieleverancier wisselen verhuizing
  - Tibber verhuizen contract
  - Frank Energie overzetten
...
## Stap 1: Meld je verhuizing tijdig aan

De eerste stap is de meest onderschatte. Vrijwel iedereen regelt het te laat.

**Wanneer melden?** Minimaal 4 weken voor de verhuisdatum, bij voorkeur 6–8 weken als het een dynamisch contract bij een kleinere aanbieder betreft.

**Wat heb je nodig om te melden?**
- Je verhuisdatum (= leveringsdatum bij de notaris)
- Het adres van de nieuwe woning
- Het EAN-nummer van de nieuwe aansluiting (staat in de koopakte of is op te vragen bij de netbeheerder via postcode + huisnummer)

**Hoe meld je het?**
Bij de meeste leveranciers kan dit via de app of het online klantenportaal. Zoek naar "Verhuizen" of "Adreswijziging." Bij Tibber doe je dit via de app onder Instellingen → Verhuizen. Frank Energie heeft een apart verhuisformulier op de website.
...
## Stap 2: Stel de eindafrekening correct in

De eindafrekening is de financiële afsluiting van je contract op het oude adres. Dit gaat vaak goed, maar fouten kosten je geld.

### Hoe werkt de eindafrekening?

Op de leveringsdatum (de dag dat jij de sleutels overdraagt) noteert de netbeheerder automatisch de meterstanden. Die standen zijn de basis voor:
1. Jouw **eindafrekening** van de leverancier (wat betaal of ontvang jij over het lopende contractjaar?)
...
### Slimme meter uitlezen: P1-poort vs. display
...
## Stap 3: Kies het juiste contract voor je nieuwe woning

Een verhuizing is hét moment om je energiecontract te heroverwegen. Je hebt geen opzegboete, je begint fresh. Maak hier gebruik van.
...
## Stap 4: Slimme meter in de nieuwe woning controleren

Niet elke woning heeft een slimme meter. En niet elke slimme meter is goed geconfigureerd voor een dynamisch contract.

### Heeft de nieuwe woning een slimme meter?
...
## Stap 5: Oplevermoment goed vastleggen

Het oplevermoment — wanneer je de sleutels overdraagt — is het cruciale moment voor de energieadministratie.

### Checklist voor het oplevermoment

- [ ] Foto van meterdisplay (dag, nacht, gas, teruglevering) met tijdstempel
- [ ] EAN-nummers genoteerd (elektriciteit én gas apart)
- [ ] Leverancier van de verkoper genoteerd (voor eventuele geschillen)
- [ ] Slimme meter communicatiemodule visueel gecontroleerd
- [ ] P1-poort vrij en toegankelijk?
- [ ] Garantiedocumenten van eventuele zonnepanelen of warmtepomp overgedragen?

### Wat als er geen automatische meterstand is geregistreerd?

Dit overkomt meer mensen dan je denkt. Bel direct je netbeheerder (Enexis, Liander of Stedin) met de opname-datum en jouw genoteerde standen. Ze kunnen dit handmatig invoeren. Heb je een foto met tijdstempel: nog beter.
...
## Dynamisch contract + nieuwe woning: zo combineer je het slim

Als je in de nieuwe woning ook zonnepanelen gaat plaatsen of een thuisbatterij overweegt, is de energie-setup belangrijk.
...
Alles elektrisch (warmtepomp, inductiekookplaat). Je verbruik van elektriciteit gaat omhoog — dynamisch contract is dan extra interessant. Lees [warmtepomp vs cv ketel 2026](/posts/warmtepomp-vs-cv-ketel-2026/) en de [beste hybride warmtepomp 2026](/posts/beste-hybride-warmtepomp-2026/) voor de context.
...
- [Verhuizen met zonnepanelen: meenemen of achterlaten?](/posts/2026-11-19-verhuizen-met-zonnepanelen-meenemen-of-laten-2026/)
- [Beste energiemonitor P1 meter 2026](/posts/beste-energiemonitor-p1-meter-2026/)

---

**Externe bron:** [ACM — Overstappen van energieleverancier](https://www.acm.nl/nl/onderwerpen/energie/energiecontracten/overstappen) — onafhankelijke informatie van de toezichthouder over rechten bij overstappen en verhuizing.
