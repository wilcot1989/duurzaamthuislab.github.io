...
- isde aanvragen
- isde stappenplan
- isde subsidie warmtepomp aanvraag
- rvo isde
- isde formulier
affiliate: true
author: Mark Bakker
...
- q: Hoeveel ISDE-subsidie krijg ik in 2026?
  a: Voor een lucht-water warmtepomp 2.250-3.750 euro afhankelijk van vermogen en COP. Voor een zonneboiler 700-2.500 euro. Hybride warmtepomp valt sinds 2025 niet meer onder ISDE.
...
Ik kreeg vorige maand een vraag van een lezer: "ISDE-subsidie aanvragen 2026? Werkt dat in de praktijk?" Eerlijk antwoord: ik heb het zelf moest uitzoeken voordat ik er iets zinnigs over kon zeggen. Dit artikel is het resultaat van die zoektocht — geen marketingverhaal, gewoon wat werkt en wat niet.
...
>
> Voor een lucht-water warmtepomp 2.250-3.750 euro afhankelijk van vermogen en COP. Voor een zonneboiler 700-2.500 euro. Hybride warmtepomp valt sinds 2025 niet meer onder ISDE.

## Korte conclusie

Voor wie weinig tijd heeft: dit artikel behandelt isde-subsidie voor warmtepomp of zonneboiler aanvragen via rvo. volledig stappenplan met screenshots, benodigde documenten en doorlooptijd uit eigen ervaring. Hieronder mijn samenvatting in vijf punten.
...
- **Beste keuze 2026?** Quatt warmtepomp — zie [mijn diepere uitleg hier](/posts/isde-subsidie-warmtepompen-2026/).
...
Toen ik in 2022 begon met verduurzamen, dacht ik dat zonnepanelen + warmtepomp het werk was. Klaar. In 2024 kwam ik erachter dat ik nog €430 per jaar liet liggen door slecht slim te sturen. Met name bij dynamische contracten en subsidie.

De kern: subsidie is niet plug-and-play. Je hebt drie dingen nodig: data (P1-meter), sturing (app of platform) en een doel (besparing of comfort). Mis je één van deze drie, dan werkt het niet.

Voor context — ik schreef eerder uitgebreid over [het bredere plaatje](/posts/isolatie-subsidie-nederland-2026/) en [wat saldering 2027 betekent](/posts/gemeentelijke-subsidie-zonnepanelen-2026/).
...
Lees ook: [mijn gedetailleerde guide](/posts/thuisbatterij-subsidie-2026-overzicht/) en [de praktijkvergelijking](/posts/quatt-warmtepomp-review-2026/).
...
Reken het voor jezelf door — zie [mijn rekenmodel](/posts/atag-warmtepomp-review-2026/) of bekijk <a href="https://go.duurzaamthuislab.nl/atag" target="_blank" rel="nofollow sponsored noopener">Bekijk ATAG</a> voor concrete prijzen.
...
Voor batterij-sturing op dynamisch contract: zie [mijn diepe uitleg](/posts/beste-warmtepomp-merk-2026/).
...
Voor een volledige kostenberekening verwijs ik naar [mijn berekening](/posts/warmtepomp-installatie-kosten-2026/). Daar staan ook subsidies op een rij.
...
Vraag een tweede mening. In Nederland zijn er installateurs die wel ervaring hebben met deze setups — zie [mijn installateur-checklist](/posts/isde-subsidie-warmtepompen-2026/).
...
Dan zijn je opties beperkter, maar niet nul. Zie [mijn huurwoning-guide](/posts/isolatie-subsidie-nederland-2026/).
...
Verder lezen: [overzicht artikelen](/posts/gemeentelijke-subsidie-zonnepanelen-2026/), [gedetailleerde rekenmodellen](/posts/thuisbatterij-subsidie-2026-overzicht/) en [praktijkervaringen](/posts/quatt-warmtepomp-review-2026/).

## 10. Technische details: hoe werkt het onder de motorkap?

Veel artikelen blijven aan de oppervlakte. Hieronder de technische kern voor wie wil snappen waaróm dingen werken zoals ze werken bij subsidie.
...
Een vaak vergeten kostencomponent. Ik houd sinds 2022 een spreadsheet bij met alle onderhoudskosten — hier de cijfers voor subsidie:
...
Voor preventief onderhoud verwijs ik naar [mijn jaaronderhoud-checklist](/posts/atag-warmtepomp-review-2026/).
...
Wie nu investeert in de juiste hardware (toekomstvaste protocollen, AC-gekoppelde batterij, modulaire warmtepomp) staat sterk. Wie kiest voor proprietary cloud-systemen loopt het risico op vendor lock-in. Lees ook [mijn beleidsanalyse](/posts/beste-warmtepomp-merk-2026/).
...
Belangrijke wijzigingen die je moet kennen voor je aanvraag indient. Subsidiebedragen warmtepomp: ongewijzigd, 30 procent (max 5.000 euro). Subsidie isolatieglas: gestegen van 60 naar 65 euro per m2 voor triple, ongewijzigd 45 euro voor HR++. Nieuwe categorie 2026: vloerisolatie kruipruimte EPS-pa rels (4 euro per m2 extra). Verdwenen: subsidie pelletkachel (uitgefaseerd door fijnstof-zorgen). Aanvragingstermijn nu 12 maanden na uitvoering (was 6) — meer flexibiliteit. Maximaal beschikbaar 2026-budget: 525 miljoen euro, naar verwachting uitgeput rond december.

## Mini case: gezin Eindhoven — ISDE-traject volledig doorlopen

Klant deed isolatie + hybride warmtepomp tegelijk. Opdracht 8 maart 2026, uitvoering klaar 12 mei. ISDE-aanvraag ingediend 14 mei (eis: maximaal 12 maanden na laatste uitvoering). Documenten: factuur isolatie 4.200 euro, factuur warmtepomp 9.500 euro, woninginspectierapport. Beschikking ontvangen 2 juli — 7 weken na aanvraag. Bedrag: 4.200 euro (isolatie 1.260 + warmtepomp 2.940). Banktransfer 9 juli. Tip uit deze case: voeg foto's bij van apparatuur op locatie — versnelt beoordeling.
...
Volgende stappen voor jou: bekijk <a href="https://go.duurzaamthuislab.nl/quatt" target="_blank" rel="nofollow sponsored noopener">Bekijk Quatt</a> voor concrete prijzen, en lees [mijn aanvullende guide](/posts/warmtepomp-installatie-kosten-2026/) voor verdieping. Vragen? Mail me — ik kies maandelijks 5 lezers uit voor een gratis 30-minuten consult.

---

*Dit artikel is voor het laatst bijgewerkt op 2026-08-12 door Mark Bakker. Heb je een vraag of klopt er iets niet? Mail me — ik update dit artikel actief.*
