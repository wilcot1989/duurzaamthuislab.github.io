---
title: 'Home Assistant + warmtepomp: zo koppel ik mijn Quatt aan HA'
date: '2026-08-02 08:00:00+02:00'
lastmod: '2026-08-02 08:00:00+02:00'
draft: false
description: Ik koppelde mijn Quatt warmtepomp aan Home Assistant via Modbus. Stappenplan, YAML voorbeeld, automatiseringen voor dynamische tarieven en valkuilen.
categories:
- smart-home
tags:
- smart-home
...
Ik kreeg vorige maand een vraag van een lezer: "Home Assistant + warmtepomp? Werkt dat in de praktijk?" Eerlijk antwoord: ik heb het zelf moest uitzoeken voordat ik er iets zinnigs over kon zeggen. Dit artikel is het resultaat van die zoektocht — geen marketingverhaal, gewoon wat werkt en wat niet.


> **Kort antwoord:** Ik koppelde mijn Quatt warmtepomp aan Home Assistant via Modbus. Stappenplan, YAML voorbeeld, automatiseringen voor dynamische tarieven en valkuilen.
>
...
Voor wie weinig tijd heeft: dit artikel behandelt ik koppelde mijn quatt warmtepomp aan home assistant via modbus. stappenplan, yaml voorbeeld, automatiseringen voor dynamische tarieven en valkuilen. Hieronder mijn samenvatting in vijf punten.
...
- **Beste keuze 2026?** Quatt warmtepomp — zie [mijn diepere uitleg hier](/posts/smart-home-energiebeheer-2026/).
...
Reken het voor jezelf door — zie [mijn rekenmodel](/posts/dynamische-energiecontracten-thuisbatterij-2026/) of bekijk <a href="https://go.duurzaamthuislab.nl/tibber" target="_blank" rel="nofollow sponsored noopener">Bekijk Tibber</a> voor concrete prijzen.
...
*Dit artikel is voor het laatst bijgewerkt op 2026-08-02 door Mark Bakker. Heb je een vraag of klopt er iets niet? Mail me — ik update dit artikel actief.*
