...
draft: false
description: ID.3 of Polestar 2 thuis slim laden op een dynamisch contract? Wij vergelijken beide auto's op app, automatiseringsmogelijkheden en te verwachten besparing, op basis van specificaties en documentatie.
categories:
- elektrisch-rijden
tags:
- elektrisch-rijden
...
"VW ID.3 vs Polestar 2 — werkt dat in de praktijk?" is een van de vaakst gestelde vragen over dit onderwerp. Hieronder zetten we op een rij wat de specificaties, handleidingen en publieke data zeggen, en waar de praktijk afwijkt van de brochure.


> **Kort antwoord:** ID.3 of Polestar 2 thuis slim laden op een dynamisch contract? Wij vergelijken beide auto's op app, automatiseringsmogelijkheden en te verwachten besparing, op basis van specificaties en documentatie.
>
...
Reken het voor jezelf door — zie [het rekenmodel](/posts/dynamische-energiecontracten-vergelijking-2026/) of bekijk <a href="https://go.duurzaamthuislab.nl/frank-energie" target="_blank" rel="nofollow sponsored noopener">Bekijk Frank Energie</a> voor concrete prijzen.
...
- **Klein huis, geen EV:** 5 kWh batterij — marktprijs €3.795 en up; in de meeste rekenmodellen 6-8 jaar terugverdientijd.
...
Volgende stap: bekijk <a href="https://go.duurzaamthuislab.nl/tibber" target="_blank" rel="nofollow sponsored noopener">Bekijk Tibber</a> voor actuele voorwaarden, en lees [de aanvullende guide](/posts/tesla-powerwall-review-nederland-2026/) voor verdieping.

## Rekenvoorbeeld: dezelfde wallbox, twee auto's

Een rekenvoorbeeld met expliciete aannames (geen meting), om te laten zien waar het verschil vandaan komt. Twee huishoudens met dezelfde wallbox en hetzelfde dynamische contract, een VW ID.3 Pro S (77 kWh) en een Polestar 2 Long Range (78 kWh), beide circa 17.000 km per jaar waarvan het grootste deel thuis geladen.

Bij een thuislaadvolume van circa 3.000 kWh per jaar en een gemiddelde laadprijs van 12 cent per kWh kom je op ongeveer €360 aan jaarlijkse laadkosten per auto. Het verschil tussen de twee auto's zit niet in het rendement van de accu, maar in hoe fijnmazig de laadsessies te plannen zijn:

- De ID.3 stuurt scheduled charging via We Connect ID; de app werkt met vaste laadvensters en reageert minder direct op prijswijzigingen.
- De Polestar 2 loopt op Android Automotive en heeft een directere koppeling met laadsturing van derden.

Wie de flexibelste koppeling heeft, kan een groter deel van het laden in de goedkoopste uren leggen. Op een jaarvolume van 3.000 kWh betekent een halve cent per kWh verschil ongeveer €15 per jaar — klein, maar het loopt op naarmate de prijsspreads groter worden.
