...
lastmod: 2026-07-02 08:00:00+02:00
description: 'BYD Battery-Box Premium HVS review: ik testte de Chinese hoogvolt-thuisbatterij. Capaciteit, prijs, betrouwbaarheid en alternatieven voor de Nederlandse markt.'
draft: false
categories:
- thuisbatterijen
tags:
...
| Metric | Waarde |
|--------|--------|
| Cycli | 110 (gem. 0,92/dag) |
| Totaal opgeslagen | 1.040 kWh |
| Round-trip efficiency (gemeten) | 92% (incl. omvormerverliezen) |
| Capaciteitsverlies | 0,5% |
| Storingsmeldingen | 3 (allemaal opgelost via firmware-update) |

De gemeten round-trip van 92% is uitstekend (DC-koppeling is altijd efficiënter dan AC). Sessy haalt 88%, Powerwall 90%. Je verliest dus minder energie in de rondgang.

Het capaciteitsverlies van 0,5% in 4 maanden is iets beter dan Enphase (0,8%) en vergelijkbaar met Powerwall.
...
Garantieafhandeling via de importeur. Ik heb één case gehoord waarbij vervanging van een module 8 weken duurde. Sessy heeft een eigen Nederlands service-team — sneller en directer.
...
Voor BYD-eigenaars adviseer ik <a href="https://go.duurzaamthuislab.nl/tibber" target="_blank" rel="nofollow sponsored noopener">Tibber</a> via Home Assistant integratie. Frank Energie kan ook, maar de API is minder volwassen voor BYD-koppeling. Verwacht 1 dag werk om HA in te richten.
...
## Mijn ervaring met BYD service

Tijdens de test had ik twee storingen:
1. **Week 6**: BMU communicatiefout. Reset opgelost na 2 uur. Geen impact.
2. **Week 14**: Module-2 in stand-by gegaan. Firmware-update via installateur opgelost.

Beide problemen werden binnen 24 uur via de installateur opgelost. Niet rampzalig, maar Sessy en Powerwall hadden in een vergelijkbare periode 0 storingen.

## ROI berekening

Voor de familie in Twello (4-persoons huishouden, 6.500 kWh/jaar verbruik, 18 zonnepanelen):
- Aanschaf totaal: €10.200 (incl. omvormer-vervanging)
- Jaarlijkse besparing zon-zelfconsumptie: €580
- Jaarlijkse winst dynamisch (via HA): €240
- Subsidie ontvangen: €0 (geen)
- Netto jaarlijkse return: €820
- **Terugverdientijd: 12,4 jaar**

Met saldering-afbouw zal dit zakken naar ~9 jaar in 2028. Toch lang. Bij Sessy in dezelfde woning zou de terugverdientijd 6,5 jaar zijn (lagere aanschafkosten).

## Mijn eindcijfer: 7/10
...
Lees ook [beste thuisbatterij Nederland 2026](/posts/beste-thuisbatterij-nederland-2026/) en [thuisbatterij vergelijking 2026](/posts/thuisbatterij-vergelijking-2026/) voor mijn complete top 10.
...
Ik zie regelmatig fouten gemaakt door particulieren die op eigen houtje een BYD willen kopen:
...
Ik vroeg de familie in Twello na 4 maanden naar hun ervaring. Antwoord: "We zijn tevreden, maar de installatie was meer rompslomp dan verwacht. Ook de app via Goodwe is niet super intuïtief. Als we het opnieuw zouden doen, zouden we waarschijnlijk Sessy kiezen — eenvoudiger en hetzelfde rendement voor de helft van de prijs."

Een eerlijke conclusie van mensen die nu wél begrijpen wat het verschil is tussen DC-gekoppeld en AC-gekoppeld, maar achteraf hadden gewild dat ze de simpelere AC-route hadden gekozen.

## Wanneer wel zeker BYD kiezen?

Eén situatie waar BYD écht de beste keuze is: nieuwe installatie zonder bestaande omvormer, groot dak (10+ kWp panelen), >15 kWh opslagbehoefte. Dan is de hybride omvormer toch nodig en betaalt de hogere efficiency zich terug. Voor zo'n setup zou ik BYD HVS 15 kWh + Goodwe ET 15 kW omvormer adviseren — totaal ~€13.000 inclusief installatie. Dat is competitief tegen Powerwall 3 + extension.
