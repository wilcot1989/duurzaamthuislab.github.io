...
- **Compressor**: het hart van het systeem, werkt op hoge druk
- **Koudemiddel**: gereguleerd door F-gassen wetgeving, alleen gecertificeerden mogen dit controleren/bijvullen
- **Warmtewisselaar**: vervuiling verlaagt efficiëntie
- **Waterpomp**: circuleert water door het systeem
- **Expansievat**: regelt drukcompensatie

De meeste onderhoudsproblemen zijn niet gevaarlijk, maar verlagen wél de prestaties. Dat merk je pas op je energierekening.
...
**Buitenunit reinigen:**
De buitenunit heeft een ventilator die lucht door een lamellenwarmtewisselaar aanzuigt. Die lamellen raken verstopt met bladeren, populierenpluizen, vuil en stof. Reinig ze met een zachte borstel of druklucht (niet te krachtig — de lamellen zijn fragiel).

Doe dit minimaal één keer per jaar, bij voorkeur in het voorjaar na de bladvalperiode. Als je bomen in de buurt hebt: ook in de herfst.

Let op: schakel de warmtepomp altijd uit voordat je de buitenunit reinigt.

**Waterdruk controleren:**
In het expansievat van het systeem zit een voordruk van ca. 1,5-2 bar. Kijk op het display (of de manometer) of de druk nog correct is. Zakt de druk elk jaar? Dat wijst op een klein lek in de installatie. Zelf bijvullen via de vulkraan is mogelijk, maar zoek ook de oorzaak.

**Luchtfilter binnenkant:**
Niet alle warmtepompen hebben een binnenunit met luchtfilter — sommige hebben alleen een buitenunit en een hydro-kit. Maar als jouw systeem een binnenunit heeft met luchtafvoer: reinig het filter elk kwartaal. Zie de handleiding voor de locatie.

**Condensatieafvoer:**
De warmtepomp produceert condens. Die loopt via een klein slangje af. Check of dit slangje niet verstopt of bevroren is. In de zomer bij koelwerking is dit nog relevanter.

**Softwareupdate:**
Moderne warmtepompen (Daikin, Nibe, Vaillant) hebben regelaars met firmware. Controleer of er updates beschikbaar zijn via de app of de webinterface. Fabrikanten verbeteren soms de stookstrategie via updates — gratis prestatieverbetering.

**COP bijhouden:**
Dit is geen onderhoud maar monitoring. Met een energiemonitor (P1-meter) kun je je verbruik meten. Deelt het warmteverbruik van je huis door het stroomverbruik van de warmtepomp: dat is je COP. Als die daalt van 3,5 naar 2,8 zonder verklaring: er is iets mis. Dat signaleer je zo vroeg mogelijk.

---

### Professioneel onderhoud: jaarlijkse servicebeurt

Dit doet de installateur:

**Koudemiddeldruk controleren:**
Met speciale manometers meet de technicus de hoge- en lagedrukzijde van het koudemiddelcircuit. Afwijkingen wijzen op lekkage of andere problemen. Alleen een F-gasensgecertificeerde technicus mag dit doen.

**Elektrische aansluitingen:**
Stroomklemmen losjes kunnen brandsporen veroorzaken. Technicus checkt alle klemmen op temperatuur en aansluitkracht.

**Veiligheidsklep en expansievat:**
Inwendige spanning van het expansievat en de instelling van de overdrukventiel worden gecontroleerd.

**Waterfilter (Y-filter):**
Tussen de warmtepomp en de vloerverwarming of radiatoren zit een fijnfilter. Die raakt vol met corrosiedeeltjes en slib. Spoelen kost 15 minuten, negeren kost je een pomp.

**Systeemrapportage:**
Een goede installateur geeft je na elke beurt een rapportje: gemeten COP, waterdruk, koudemiddeldruk, conditie van componenten. Bewaar die. Bij garantieclaims is dat goud waard.
...
## Het 5-jaarlijkse grote onderhoud

Na 5 jaar zijn sommige onderdelen aan vervanging of uitgebreide controle toe:

**Waterpomp:**
De circulatiepomp in het systeem (die het warm water door je radiatoren stuurt) heeft een levensduur van 8-15 jaar, maar na 5 jaar is het slim om de lagergeluiden en drukopbouw te controleren. Vervangen kost €150-300 inclusief arbeid.

**Expansievat:**
Na 5-7 jaar kan de membraan in het expansievat doorlaten. Symptoom: wisselende waterdruk die steeds terugzakt. Vervangen: €100-200.

**Koudemiddel F-gassencontrole:**
Bij systemen met koudemiddel boven 5 ton CO₂-equivalent (GWP × kilo's) is periodieke controle wettelijk verplicht. Check bij je installateur of jouw systeem hieronder valt.

**Laminaatreiniger:**
Na 5 jaar zit er oxidatielaag op de lamellen van de buitenunit. Professionele reiniging met speciale reinigingsmiddelen (niet met hogedrukspuit — dat vernielt de lamellen) is aan te raden.

**Verwarmingscircuit ontluchten:**
In een verwarmingssysteem accumuleert lucht. Na 5 jaar: volledig ontluchten via de ontluchtingsschroeven bij radiatoren en de warmtepomp. Kost 1-2 uur arbeid.

**Totale kosten groot onderhoud (5-jaarlijks):** €350-700 afhankelijk van wat er nodig is.
...
**Fout 3: Waterdruk te hoog bijvullen**
Te hoge waterdruk (boven 2,5 bar) belast de installatie. Vul bij tot 1,5-2,0 bar, niet meer.

**Fout 4: Buitenunit hogedrukspuiten**
Met een hogedrukreiniger op de buitenunit gaan de dunne aluminium lamellen krom. Gebruik een zachte borstel of gewone tuinslang.

**Fout 5: Geen onderhoudshistorie bijhouden**
Als je de woning wil verkopen of een garantiesclaim wilt indienen: bewaar elk onderhoudsrapport. Maak een map, fysiek of digitaal.

---

## Checklist: warmtepomp jaarlijks onderhoud

Print dit uit en hang het bij je warmtepomp:

**Elk kwartaal (zelf doen):**
- [ ] COP controleren via energiemonitor
- [ ] Waterdruk controleren (display of manometer)
- [ ] Buitenunit visueel inspecteren op blaadjes/vuil

**Elk voorjaar (zelf doen):**
- [ ] Buitenunit reinigen (borstel, geen druk)
- [ ] Luchtfilter reinigen of vervangen
- [ ] Condensatieafvoer controleren
- [ ] Software/firmware versie controleren

**Jaarlijks (installateur):**
- [ ] Koudemiddeldruk meten
- [ ] Elektrische aansluitingen controleren
- [ ] Waterfilter (Y-filter) spoelen
- [ ] Expansievat controleren
- [ ] Systeemrapport ontvangen en opslaan

**5-jaarlijks (installateur):**
- [ ] Waterpomp en circulatiepomp inspecteren
- [ ] Expansievat membraan beoordelen
- [ ] Professionele lamellenwassing buitenunit
- [ ] Volledig verwarmingscircuit ontluchten
- [ ] F-gassencontrole indien van toepassing

---

## Tot slot: onderhoud is geen kostenpost maar een investering
