...
lastmod: 2026-07-01 08:00:00+02:00
description: 'Enphase IQ Battery 5P review: ik testte de modulaire AC-batterij van 5 kWh op een Nederlands dak. Prestaties, prijs, app, voor- en nadelen na 4 maanden gebruik.'
draft: false
categories:
- thuisbatterijen
tags:
...
- q: 'Hoeveel cycli haalt de batterij?'
  a: 'Enphase specificeert 6.000 cycli bij 100% DoD. Bij dagelijkse cyclus (zon-zelfconsumptie) is dat 16+ jaar. In mijn test verloor de batterij 0,8% capaciteit in 4 maanden, dus ongeveer op schema.'
products:
...
- name: Tibber dynamisch contract
  ...
  price: '6'
---
In oktober 2025 werd ik gebeld door een klant in Soest die zijn 18 zonnepanelen wilde uitbreiden met opslag. Hij twijfelde tussen Sessy, Tesla Powerwall en de relatief nieuwe Enphase IQ Battery 5P. We kozen voor de Enphase, en ik mocht de installatie en monitoring vier maanden volgen.

Hieronder mijn eerlijke bevindingen: wat werkt goed, waar de zwaktes liggen, en voor wie deze batterij echt geschikt is.
...
> **Kort antwoord:** Enphase IQ Battery 5P review: ik testte de modulaire AC-batterij van 5 kWh op een Nederlands dak. Prestaties, prijs, app, voor- en nadelen na 4 maanden gebruik.
>
...
In de eerste week vond ik twee verbruikslekken in het huis dankzij de gedetailleerde data: een vergeten oude diepvries op zolder (110 kWh/maand!) en een aquariumpomp die 24/7 draaide. Alleen al door die twee uit te zetten bespaart de eigenaar €38/maand.

Sessy en Marstek hebben ook apps, maar minder uitgebreid op verbruiksinzicht.

## Prestaties na 4 maanden

Periode: november 2025 t/m februari 2026. Gegevens uit Enlighten:

| Metric | Waarde |
|--------|--------|
| Aantal cycli | 102 (gemiddeld 0,85/dag) |
| Totaal opgeslagen | 870 kWh |
| Round-trip efficiency | 90,2% |
| Capaciteitsverlies | 0,8% |
| Stilstand-uren | 12 (allemaal vóór software-update) |

De round-trip efficiency van 90,2% is uitstekend. Sessy haalt typisch 88%, Powerwall 90%. Het capaciteitsverlies van 0,8% in 4 maanden ligt op schema voor de 15 jaar / 60%-belofte.
...
In zonarme maanden november-februari verdiende de Sessy in een vergelijkbare opstelling €180; de Enphase verdiende slechts €60 omdat hij niet zelfstandig handelt.
...
Als je toch dynamisch wilt handelen met Enphase, raad ik <a href="https://go.duurzaamthuislab.nl/tibber" target="_blank" rel="nofollow sponsored noopener">Tibber</a> of <a href="https://go.duurzaamthuislab.nl/frank-energie" target="_blank" rel="nofollow sponsored noopener">Frank Energie</a> aan. Beide hebben goede APIs die via Home Assistant of IFTTT met Enphase te koppelen zijn. Verwacht een week prutsen om het werkend te krijgen.

Lees ook mijn [dynamische energiecontracten vergelijking](/posts/dynamische-energiecontracten-vergelijking-2026/) voor de juiste keuze.
...
Voor een 5 kWh setup zou ik adviseren:
...
Lees ook [beste thuisbatterij eengezinswoning](/posts/beste-thuisbatterij-eengezinswoning-2026/) voor mijn complete vergelijking.
...
## Wat zegt mijn klant na 4 maanden?

Ik vroeg de eigenaar in Soest hoe hij de Enphase ervaart. Zijn antwoord: "Ik ben blij met de batterij, maar ik had voor hetzelfde geld twee Sessy's kunnen kopen of een Powerwall 3. De app is geweldig, het inzicht in mijn verbruik is enorm verbeterd. Maar dat ik €1.500 moest betalen voor de System Controller om noodstroom te krijgen, voelt als afpersing."

Een eerlijke samenvatting van een tevreden maar kritische klant.

## Software updates en betrouwbaarheid

In de eerste maand was er één firmware-update die 6 uur duurde (de batterij stond dan in standby). In maand 2 een tweede update van 2 uur. Sinds december geen updates meer. Geen storingen, geen offline meldingen, geen support tickets gehad.

Enphase doet zijn updates 's nachts, wat slim is. Sessy doet dit ook, Marstek soms overdag (irritant).

## Energiebeheer-strategie

Voor maximaal rendement met Enphase 5P heb ik deze strategie ingesteld:
...
Met deze strategie haalde de Enphase een gemiddelde dagopbrengst van €2,80 in januari 2026 (niet slecht voor de donkerste maand). Sessy in een vergelijkbaar huis: €3,40/dag. Het verschil zit puur in de minder slimme dynamische handel.

## Onderhoud

Geen onderhoud nodig. Geen jaarlijkse keuring, geen filter-vervanging, geen koelvloeistof. Wel adviseer ik:
...
Ik heb in januari 2026 een noodstroom-test gedaan: hoofdschakelaar uit, kijken wat er gebeurt. De IQ System Controller schakelt over in <100 ms (sneller dan ik kon merken). Het backup-circuit (koelkast, lampen, modem, één wandcontactdoos) bleef draaien. Met 10 kWh capaciteit hield dat 14 uur vol op normaal verbruik.
...
Voor de eigenaar in Soest:
- Aanschaf: €9.750
- Jaarlijkse besparing zon-zelfconsumptie: €420
- Jaarlijkse winst dynamisch handel (via IFTTT): €280
- Jaarlijkse besparing op verbruikslek-detectie: €450
- Totale jaarlijkse return: €1.150
- Terugverdientijd: 8,5 jaar

Met saldering-afbouw na 2027 zal de zon-zelfconsumptie waarde stijgen naar €600-€700/jaar. Dan zakt de terugverdientijd naar 6-7 jaar. Bij Sessy in dezelfde woning zou de terugverdientijd 5,5 jaar zijn.
...
**Kan ik later modules bijplaatsen?** Ja, dat is juist het sterke punt. Eerste module €4.200 inclusief installatie, extra modules €3.400 per stuk (alleen hardware, installatie 2 uur).
...
**Krijg ik de ISDE-subsidie?** Op dit moment niet, want ISDE geldt voor warmtepompen en zonneboilers, niet voor thuisbatterijen. Sommige gemeentes hebben wel een aparte batterijsubsidie. Zie [thuisbatterij subsidie 2026](/posts/thuisbatterij-subsidie-2026-overzicht/).
