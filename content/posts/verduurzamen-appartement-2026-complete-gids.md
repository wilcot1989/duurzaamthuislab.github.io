...
- name: Sessy
  ...
  price: '2495'
schema_type: Article
last_updated: '2026-10-30'
faq:
- q: 'Heb ik VvE-toestemming nodig voor een infraroodpaneel?'
  a: 'Voor losse infraroodpanelen in je eigen woning niet — dat is gewoon een elektrisch apparaat. Voor aansluiting in gemeenschappelijke ruimtes of doorvoeren door buitenmuren wel. Plak-aan-de-wand panelen van 600 W vallen onder normale stoffering, zoals een radiator-vervanger.'
- q: 'Mag een plug-and-play batterij in een appartement?'
  a: 'Ja, een plug-in batterij tot 800 W (zoals Marstek Venus E of kleine Sessy-units) sluit je aan op een normaal stopcontact. Geen vergunning nodig, geen VvE-toestemming. Wel: check je groep — niet meer dan 2.3 kW continu op één groep.'
...
- **Eigen dak-zonnepanelen** — alleen via VvE-besluit, zie [vergunning monumenten/VvE](/posts/vergunning-zonnepanelen-monumenten-vve-2026/).
- **Eigen warmtepomp** — bij blokverwarming onmogelijk, bij eigen ketel mogelijk maar dure ingreep (en VvE-toestemming voor buitenunit).
...
**Valkuil 2: VvE-akkoord verwachten binnen 6 maanden.** Reken op minimaal een jaar. Begin daarom altijd met dingen die je zonder VvE kunt doen.

**Valkuil 3: infrarood inzetten als hoofdverwarming.** Verbruik wordt 4-7x hoger dan een warmtepomp. Alleen voor spot-comfort gebruiken.

## 8. Welk product past bij wie?

### Appartement-bewoner met blokverwarming
...
Veel artikelen blijven aan de oppervlakte. Hier de technische kern voor wie wil snappen waaróm dingen wel of niet werken bij appartement-verduurzaming.
...
|---|---|---|
| HomeWizard P1-meter | 0 | 8-12 jaar |
| Tado-thermostaat | 0 | 8-10 jaar |
| Plug-in batterij Marstek/Sessy | 0-45 | 12-18 jaar |
| Infraroodpaneel | 0-25 | 15-25 jaar |
| Slimme radiatorknoppen | 8-15 (batterijen) | 7-10 jaar |

Belangrijk: bij verhuizing nemen veel huurders en appartement-eigenaren hun spullen mee. Dus de "levensduur" loopt vaak gewoon door in de volgende woning.

## 12. Drie veelgemaakte fouten van appartement-bewoners

**Fout 1: opgeven omdat de VvE moeilijk doet.** Veel verduurzaming kan zonder VvE-traject. Start daar.

**Fout 2: alle ingrepen tegelijk willen doen.** Stapsgewijs werkt beter — meet eerst met de P1, dan pas batterij, dan pas verdere stappen.
...
|---|---|---|
| Investering verduurzaming | 350-2.800 euro | 11.000-28.000 euro |
| Jaarbesparing | 250-900 euro | 1.200-2.800 euro |
| Terugverdientijd | 1-5 jaar | 6-12 jaar |
| Onafhankelijkheid VvE | Beperkt | Volledig |
| Vergunningen | Vaak VvE-besluit | Vaak alleen melding |
...
**Penthouse met dakterras.** Mogelijke kandidaat voor balkonpanelen (sinds 2025 tot 800 W toegestaan) en zelfs zelfstandige zonneboiler. VvE-toestemming nodig voor de installatie op het dak.

**Senioren-appartement in een wooncomplex.** Vaak vooraf-geregelde VvE met groot reservefonds — eenvoudig om collectieve zonnepanelen voor te stellen. Verlopen vaak via een installatieplan van de woon-corporatie of -coöperatie.

In alle drie gevallen: start met de no-regret-stappen (P1, dynamisch contract, slimme thermostaat), wacht niet op het grote plan.
...
**Externe bron:** [RVO — verduurzamen VvE en appartement-eigenaren](https://www.rvo.nl/onderwerpen/verduurzamen-van-vastgoed/vve) — onafhankelijke informatie over dit onderwerp.
