...
- **Geen marge op stroomprijs**: je betaalt exact het EPEX day-ahead tarief plus btw en netbeheer
- **Vast servicegeld**: €5,99/maand, ongeacht verbruik
...
Pure transparantie. Je ziet de EPEX-prijs, en betaalt exact dat. Frank Energie idem. Anderen niet — Eneco Dynamisch rekent €0,015/kWh marge bovenop, Greenchoice €0,02. Op 4.000 kWh per jaar is dat €60-€80 verschil.
...
Tibber rekent geen aparte terugleverkosten zoals vele anderen. Bij teruglevering krijg je het uurtarief, met spike-bescherming bij negatieve prijzen (max €0,03/kWh negatief in plaats van -€0,15 op zware dagen).

### 6. Tibber Pulse: realtime inzicht

Voor €90 eenmalig krijg je een Tibber Pulse — een ledlampje en sensor die op de P1-poort van je slimme meter klikt. Gevolg: je ziet in de app je verbruik per seconde realtime. Werkelijk inzicht. Niet 1× per dag een achterstallige uitlezing zoals Eneco, maar live.

## Waarom Tibber soms minder goed is

### 1. Servicegeld €5,99/maand

Voor lage-volume gebruikers (< 2.000 kWh/jr) is Tibber soms niet voordelig genoeg. Het servicegeld eet je voordeel op. Een huishouden met 1.500 kWh verbruik en weinig flexibiliteit kan beter bij Engie (€3 vast servicegeld) of Greenchoice (€4) terecht.
...
Optionele aankoop, maar de helft van Tibber's smart-features zijn pas écht nuttig met Pulse. €90 erbij verzwaart de eerste maand-investering.
...
| Pulse / realtime sensor | Tibber Pulse €90 | EnergyZero (compatibel) gratis |
