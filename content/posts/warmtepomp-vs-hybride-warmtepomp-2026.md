...
Een full-electric warmtepomp verplaatst warmte uit de buitenlucht naar je woning. Het principe is vergelijkbaar met een koelkast maar dan omgekeerd: de koelkast ontrekt warmte aan de binnenkant en blaast die buiten uit; een warmtepomp ontrekt warmte aan de buitenlucht en brengt die binnen.

Voor elke kWh elektriciteit die de warmtepomp verbruikt, produceert hij 3-5 kWh warmte. Dit noemen we de COP (Coefficient of Performance). Een COP van 4 betekent viermaal zoveel warmte als de gebruikte stroom.

**Full-electric warmtepompen in Nederland:**
- Lucht-water warmtepomp (meest verkocht): trekt warmte uit de buitenlucht
- Bodem-water warmtepomp: trekt warmte uit de grond via een bodemlus (hogere investering, stabielere COP)
- Water-water warmtepomp: trekt warmte uit grondwater (vereist vergunning)

### Wat is een hybride warmtepomp?

Een hybride warmtepomp combineert een compacte lucht-water warmtepomp met je bestaande cv-ketel. De warmtepomp is het primaire verwarmingssysteem bij temperaturen boven -5 tot 0°C (afhankelijk van het merk). Zodra het kouder wordt of de vraag naar warm water hoog is, springt de cv-ketel automatisch bij.

Dit systeem is minder efficiënt dan full-electric (er wordt nog gas gebruikt) maar aanzienlijk goedkoper in aanschaf en meer geschikt voor minder goed geïsoleerde woningen.

---

## Technische vergelijking

### COP: de sleutel tot rendement

| Systeem | COP gemiddeld | COP bij -10°C | COP bij +7°C |
|---------|---------------|----------------|---------------|
| Full-electric lucht-water | 3,0-4,5 | 1,8-2,5 | 3,5-5,0 |
| Full-electric bodem-water | 4,0-5,5 | 3,5-4,5 | 4,5-6,0 |
| Hybride (warmtepomp-deel) | 3,0-4,2 | — (ketel neemt over) | 3,2-4,5 |

De COP van een full-electric warmtepomp daalt bij vriesweer. Bij -10°C werkt een lucht-water warmtepomp nog wel, maar met een COP van minder dan 2,5. Dat is nog steeds efficiënter dan een cv-ketel op gas (rendementswaarde 0,9-1,0 kWh warmte per kWh gas-energie), maar minder indrukwekkend dan de marketingwaarden van zomercondities.

Een hybride warmtepomp omzeilt dit probleem: de ketel neemt het over bij vriesweer, zodat de warmtepomp alleen actief is in zijn meest efficiënte werkbereik.

### Aanvoertemperatuur: de kritische factor

Een full-electric warmtepomp werkt het efficiëntst bij lage aanvoertemperaturen (35-45°C). Vloerverwarming en lagetemperatuur-radiatoren zijn ontworpen voor dit bereik.
...
## Full-electric: wanneer is het de slimste keuze?

Een full-electric warmtepomp is financieel het meest aantrekkelijk als:

1. **Je woning is goed geïsoleerd** (energielabel A of B)
2. **Je hebt vloerverwarming of lagetemperatuur-radiatoren** (aanvoer ≤ 45°C)
3. **Je hebt of plaatst zonnepanelen** (goedkope zelfopgewekte stroom verhoogt het voordeel)
4. **Je wilt volledig van gas af** (toekomstbestendig bij stijgende gasprijzen)
5. **Je koopt een nieuwe woning** die al aan de eisen voldoet
...
Een hybride warmtepomp is financieel het meest aantrekkelijk als:

1. **Je woning is matig of slecht geïsoleerd** (energielabel C, D, E, F of G)
2. **Je hebt hoge-temperatuur radiatoren** en wil die voorlopig houden
3. **Je wilt risico beperken** en niet direct €10.000+ investeren
...
## De route van hybride naar full-electric

Veel energieadviseurs raden een tweestapsstrategie aan:

**Stap 1 (nu):** Hybride warmtepomp installeren → direct 40-60% gasreductie, snel terugverdiend.
